...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=nitashav-vmw&repo=bankapi",
  "namespace" : "nitashav",
  "projectName" : "bankapi",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->bankapi]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=nitashav-vmw&repo=bankapi'
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [new-namespace->nitashav, fiserv-accelerator->bankapi]
